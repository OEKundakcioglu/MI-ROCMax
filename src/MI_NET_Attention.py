# -*- coding: utf-8 -*-
"""
Created on Tue May 17 15:00:00 2022
...
from mil.nn.models import MI_Net_Attention
...
def MI_NET_Attention_cv(data_dir_,Datasets,replications,folds):
    ...
    for dataSet in Datasets:
        ...
        for rep,fold in rep_fold:
            ...
            batch_size = 1
            data_dir =data_dir_+'/'+dataSet+'.xlsx'
            test_index_dir = data_dir_+'/'+dataSet+".csv_rep"+rep+"_fold"+fold+".txt"
            inputDim = prepareCVData(dataSet, pd.read_csv(data_dir_+'/'+dataSet+'.csv'), rep, fold)[0]
            ...
            model = MI_Net_Attention(input_dim=inputDim)   # build the model
            ...
            results.to_csv("Results/MI_NET_Attention.csv")
