# -*- coding: utf-8 -*-
"""
Created on Tue May 17 14:58:12 2022
...
from mil.nn.models import MI_Net_RC
...
def MI_NET_RC_cv(data_dir_,Datasets,replications,folds):
    ...
    for dataSet in Datasets:
        ...
        for rep,fold in rep_fold:
            ...
            model = MI_Net_RC(input_dim=inputDim)   # build the model
